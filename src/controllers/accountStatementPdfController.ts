...
// Mirrors the data-building logic in reportsController.accountStatement
// but pipes the result through the branded PDF generator instead of JSON.
// Includes legacy invoices (no accountId) matched by billToName.
